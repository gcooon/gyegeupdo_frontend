...
export const TIER_CONFIG: Record<TierLevel, {
  ...
  S: {
    ...
    label: 'S급',
    color: '#FFB6C1',
    gradient: 'linear-gradient(135deg, #FFC0CB 0%, #FFB6C1 50%, #FF9CAD 100%)',
  ...
  A: {
    ...
    label: 'A급',
    color: '#FFDAB9',
    gradient: 'linear-gradient(135deg, #FFE4C9 0%, #FFDAB9 50%, #FFCBA4 100%)',
    glow: '0 0 12px rgba(255, 218, 185, 0.5)',
    borderColor: '#FFDAB9',
  ...
  B: {
    ...
    label: 'B급',
    color: '#FFFFE0',
    gradient: 'linear-gradient(135deg, #FFFFF0 0%, #FFFFE0 50%, #FFFACD 100%)',
    glow: '0 0 10px rgba(255, 255, 224, 0.5)',
    borderColor: '#FFFFE0',
