...
const MOCK_CHARTS: UserTierChart[] = [
  ...
  },
  {
    ...
    is_featured: true,
    visibility: 'public',
    share_url: '/my-tier/coffee-franchise-tier',
  ...
  },
  {
    ...
    is_featured: true,
    visibility: 'public',
    share_url: '/my-tier/delivery-app-tier',
  ...
  },
  {
    ...
    is_featured: true,
    visibility: 'public',
    share_url: '/my-tier/convenience-store-dosirak-tier',
